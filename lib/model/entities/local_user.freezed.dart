...
abstract class $LocalUserCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String? displayName, String? email, String? uid, String? photoUrl});
}
...
class _$_LocalUser implements _LocalUser {
  const _$_LocalUser({this.displayName, this.email, this.uid, this.photoUrl});
  ...
  @override
  String toString() {
    return 'LocalUser(displayName: $displayName, email: $email, uid: $uid, photoUrl: $photoUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, displayName, email, uid, photoUrl);
...
abstract class _LocalUser implements LocalUser {
  const factory _LocalUser(
      ...
      final String? email,
      final String? uid,
      final String? photoUrl}) = _$_LocalUser;
